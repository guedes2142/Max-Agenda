...
#LabelNome
#----------------------------------------------------------------------------------------------------------
labelNome = Label(layoutNome, width=33, height=2, text='Rafael Guedes', font='Verdana 10 bold', bg='white', fg='black')
...
app_logo = Label(layoutPhoto, width=120, image=logotipo, compound=LEFT, relief='flat', anchor='center' ,bg='white')
...
def updateInformation():
    ...
    try:
        ...
        btnConfirme = Button(opiton,command=update, text='Confirma' ,width=7, height=1, font='Verdana 7 bold', bg=cor3, fg='black', relief=GROOVE)
...
#Entries 
#----------------------------------------------------------------------------------------------------------
inputName = Label(frameEntry, width=10, height=2, text='Nome:', font='Verdana 10 bold',bg='white' )
inputName.grid(row=0, column=0, sticky=NSEW, padx=5)
entryName = Entry(frameEntry, width=20,font='Verdana 10 ', relief=SOLID)
entryName.grid(row=0,column=1)

inputPhone = Label(frameEntry, width=10, height=2, text='Contato:', font='Verdana 10 bold',bg='white' )
inputPhone.grid(row=1, column=0, sticky=NSEW, padx=5)
entryPhone = Entry(frameEntry, width=20,font='Verdana 10 italic', relief=SOLID)
entryPhone.grid(row=1,column=1)

inputEnd = Label(frameEntry, width=10, height=2, text='Endereço:', font='Verdana 10 bold',bg='white' )
...
inputObs = Label(frameEntry, width=10, height=2, text='Notas:', font='Verdana 10 bold',bg='white' )
inputObs.grid(row=4, column=0, sticky=NSEW, padx=5)
entryObs = Text(frameEntry, width=20,  height= 5, font='Verdana 10 italic', relief=SOLID)
entryObs.grid(row=4,column=1)

inputdata = Label(frameEntry, width=10, height=2, text='Data:', font='Verdana 10 bold',bg='white', fg='black')
inputdata.grid(row=3, column=0, sticky=NSEW, padx=5)
entrydata = DateEntry(frameEntry, width=12, height= 1, font='Verdana 10 italic', bg='dar kblue',fg='white',relief=SOLID,)
...
#----------------------------------------------------------------------------------------------------------
btnDonation = Button(frameEntry, width=8, command=donation ,height=2, text='CONTRIBUA', font='Verdana 8 bold',bg=cor7,fg='black', relief=FLAT, overrelief='solid' )
btnDonation.grid(row=5, column=0, pady=5, padx=5,sticky=NSEW)
btnSpotify = Button(frameEntry, width=10, command=openSpotify ,height=2, text='Abrir Spotify', font='Verdana 8 bold',bg=cor3,fg='black', relief=FLAT, overrelief='solid' )
btnSpotify.grid(row=5, column=1, pady=5, padx=5,sticky=W)
btnGmail = Button(frameEntry, width=10, command=openGmail ,height=2, text='Abrir Gmail', font='Verdana 8 bold',bg=cor6,fg='black', relief=FLAT, overrelief='solid' )
btnGmail.place(x=210, y=241)

#Botoes
#----------------------------------------------------------------------------------------------------------
btnAdd = Button(opiton, text='Adiconar' ,command=insertSubject ,width=8, height=1, font='Verdana 10 bold', bg=cor4, fg='black', relief=FLAT)
btnAdd.grid(row=0, column=0, pady=2, padx=45)

btnEdit = Button(opiton,command=updateInformation, text='Editar' ,width=8, height=1, font='Verdana 10 bold', bg=cor4, fg='black', relief=FLAT)
btnEdit.grid(row=0, column=1)

btnESave = Button(opiton, command=display_info, text='Ver Info:' ,width=8, height=1, font='Verdana 10 bold', bg=cor3, fg='black', relief=FLAT)
btnESave.grid(row=1, column=0)

btnDel = Button(opiton,command=deletar, text='Deletar',width=8, height=1, font='Verdana 10 bold', bg=cor6, fg='black', relief=FLAT)
...
def showInfo():
    ...
    tree = ttk.Treeview(displayOne, selectmode='extended', columns=tabela_header, show='headings')
